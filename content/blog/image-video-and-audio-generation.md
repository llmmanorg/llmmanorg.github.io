...
<img src="https://github.com/llmmanorg/llmmanorg.github.io/releases/download/blog-media-generation/manatee.png" alt="A manatee in a sunlit lagoon, generated by LTX-2.3" width="768" height="512" loading="lazy">
...
The first `run` pulled `ltx-2.3` from Docker Hub: the distilled
